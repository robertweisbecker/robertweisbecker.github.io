    ...
    <Article pageKey="furnace">
      ...
      <Stack spacing={8}>
        ...
        <UnorderedList spacing={4}>
          ...
          <ListItem>
            ...
            and QA were nearly impossible because we had no underlying styles
            for the components. Instead, variables were set to values matching
            the course they were originally built for – leaving any
            documentation we created littered with mismatched fonts, white text
            on white, and a whole Skittles bag full of icon colors.
          </ListItem>
          <ListItem>
            <b>Responsive layout and type with additional flexibility.</b> We
            had 13 different layout components – none of which were a grid.
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            ...
            convention within our code made it difficult to predict the effect
            of a given class or variables and made it impossible to align our
            Figma library styles with themeable properties.
          </ListItem>
        </UnorderedList>
      </Stack>
      <Stack spacing={8}>
        ...
        <Text>
          ​Changing one value affects all of its instances throughout the
          system, allowing for a consistent application of visual style in a
          scalable and maintainable way.​ Each component was refactored to
          utilize only these global variables for all of its styling:
        </Text>
      ...
      <Stack spacing={8}>
        ...
        <LayoutGrid variant="twoUp">
          <Text>
            ...
            and 600. This is done to enforce visual separation between primary
            and secondary elements, since three dark and three light variants
        ...
        <LayoutGrid variant="twoUp">
          <Stack>
            ...
            <Text>
              ...
              communicates the intended message to learners. For example, the
              default informational color is purple, but a theme with purple
              buttons should opt for a different semantic informational color
              like blue.
            </Text>
          </Stack>
          <ImageModal
        ...
        <LayoutGrid variant="twoUp">
          <Stack>
            ...
            <Text>
              ...
              contrast ratio. Course designers are discouraged from overriding
              these colors without first verifying the relative contrast of a
              replacement palette.
            </Text>
          </Stack>
          <ImageModal
      ...
      <Stack spacing={8}>
        ...
        <LayoutGrid variant="twoUp">
          <Stack>
            <Text>
              The transparent neutral palette is designed for subdued or
              disabled UI elements, dividers, or accents, typically using
              opacities of Neutral 900, but are defined separately for greater
              theme control.
            </Text>
            <Text>
              This separation allows theme designers to use handpicked colors
              for overlays and ensures that disabled colors, using a
              semi-transparent midtone, are visible on both light and dark
              backgrounds.
            </Text>
          </Stack>
          <ImageModal
      ...
      <Stack spacing={8}>
        ...
        <Text>
          ...
          flexible grid. While there were a number of layout components (12!),
        ...
        <Text>
          ...
          Boostrap-style 12-column grid for full flexibility, and another
          inspired by
          <LinkOut
          ...
          mobile, 8 on tablet, and 12 on desktop) for easier configuration.
        </Text>
      ...
      <Stack spacing={8}>
        ...
        <LayoutGrid variant="twoUp">
          <Text>
            ...
            the page. Themes can customize these elevations, such as using
            'none' for a flat theme or tinting shadows with a color from their
            palette. Some themes have even used layered box-shadows to add an
            additional border to elements upon interaction.
          </Text>
          <ImageModal
      ...
      <Stack spacing={8}>
        ...
        <Text>
          With styles in Figma aligned to our primitive variable names,
          designers were empowered to plug those values into an SCSS theme
          template and ship it off to a developer to push. The consistent naming
          also facilitated reusing designs from different courses, since
          designers could readily swap libraries.
        </Text>
      ...
      <Stack spacing="5">
        ...
        <Text>
          ...
          flexible, general-purpose ones, such as our new responsive layout
          grid. We also upgraded our dependencies with an eye toward easier
          maintenance and scalability moving forward.
        </Text>
      </Stack>
      <Stack spacing="5">
        ...
        <Text>
          ...
          directional icons, such as arrows and chevrons.
        </Text>
        <Text>
      ...
      <Stack spacing="5">
        ...
        <Text>
          The launch of Furnace and its emphasis on accessibility allowed the
          organization to develop a more mature and rigorous accessibility
          practice. For more insight into some of our processes and tooling,
