import { ButtonGroup, Image, Box, IconButton, Stack, Text, Container } from "@chakra-ui/react";
...
const Footer = () => {
	return (
		<Container maxW="container.lg" as="footer" role="contentinfo" borderTop="1px" borderColor="border.subdued" py={5}>
            ...
            src="/assets/logo.png"
          /> */}
					<Text fontSize="2xs" color="fg.subdued">
