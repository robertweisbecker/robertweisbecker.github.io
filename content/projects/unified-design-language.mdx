...
<figure
  data-media
  className="not-prose relative my-0 flex w-full flex-col items-center gap-1.5 self-center max-sm:-mx-4 max-sm:w-[calc(100%+(--spacing(8)))] max-sm:max-w-[unset]"
>
  <div className="sm:squircle w-full bg-card py-1 shadow-border-sm sm:rounded-xl sm:px-1 dark:bg-muted">
    <div
      className="sm:squircle relative w-full overflow-hidden sm:rounded-[calc(var(--radius-xl)---spacing(1))]"
