...
<ProjectImageCarousel
  slides={[
    { src: "/assets/udl/login-after.png", alt: "One sign-in screen to rule them all", caption: "One sign-in screen to rule them all" },
    { src: "/assets/udl/create-after.png", alt: "Aligning admin and K12 platform login flows", caption: "Aligning admin and K12 platform login flows" },
    { src: "/assets/udl/evaluations-after.png", alt: "Evaluations in platform and course contexts", caption: "Evaluations in platform and course contexts" },
  ]}
/>
...
<ProjectImageCarousel
  slides={[
    ...
    { src: "/assets/udl/base-tokens.png", alt: "Some of our base (global) tokens", caption: "Some of our base (global) tokens" },
