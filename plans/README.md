...
Generated by the improve skill on 2026-07-01 against commit `38540a2`; refreshed after pulling `origin/master` to commit `f87f0ad` on 2026-07-01. Execute in the order below unless dependencies say otherwise. Each executor: read the plan fully before starting, honor its STOP conditions, and update
your row when done.

## Audit Summary

Scope: standard audit of the Next.js App Router personal site in `/Users/robertweisbecker/.codex/worktrees/8797/robertweisbecker.github.io`, then reconciliation after the merged maintainability PR. I read root docs/config, package scripts, the App Router tree, high-churn UI/demo files, private
routes, the Letterboxd API path, and representative utilities/components.
