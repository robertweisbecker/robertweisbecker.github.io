		...
		<div className="mt-10 flex flex-col gap-10">
			...
			<LayoutGrid variant="oneThird">
				...
				<div className="flex flex-col gap-4">
					...
					<p>
						...
						learner products. Read a bit about that process <Link href="/unified-design-language">here</Link>.
					</p>
			...
			<LayoutGrid variant="oneThird">
				<div className="mb-5 flex items-center gap-2">
					...
					<Heading level={6}>
						What <span className="font-normal text-muted-foreground">(I look like)</span>
					</Heading>
				</div>
				<div>
					<img
			...
			<LayoutGrid variant="oneThird">
				<div className="mb-5 flex items-center gap-2">
					...
					<Heading level={6}>
						What
						<span className="font-normal text-muted-foreground"> (I&apos;ve done)</span>
					</Heading>
				</div>
				<div className="flex flex-col gap-4">
					<p>
			...
			<LayoutGrid variant="oneThird">
				<div className="mb-5 flex items-center gap-2">
					...
					<Heading level={6}>
						Where <span className="font-normal text-muted-foreground">(I&apos;ve worked)</span>
					</Heading>
				</div>
			...
			<LayoutGrid variant="oneThird">
				<div className="mb-5 flex items-center gap-2">
					...
					<Heading level={6}>
						Where <span className="font-normal text-muted-foreground">(I learned things)</span>
					</Heading>
				</div>
				<div className="flex flex-col space-y-2 gap-2 divide-y divide-border/50 text-sm">
					<p className="font-semibold text-base">Maryland Institute College of Art</p>
					<div className="flex items-center py-2">
						<span>Master&apos;s, UX Design</span>
						<span className="flex-1" />
						<span className="font-mono text-muted-foreground">2016–2017</span>
					</div>
					<p className="mt-4 font-semibold text-base">University of Michigan, Ann Arbor</p>
			...
			<LayoutGrid variant="oneThird">
				<div className="mb-5 flex items-center gap-2">
					...
					<Heading level={6}>
						What <span className="font-normal text-muted-foreground">(is this site?)</span>
					</Heading>
				</div>
				<div className="flex flex-col gap-4 text-muted-foreground">
					<p>This is my little corner of the internet. If you&apos;re reading this now, I made it for you.</p>
					<p>
						You can also get here from{" "}
						<a href="https://bob.cash" target="_blank" rel="noopener noreferrer">
							bob.cash
						</a>
						,{" "}
						<a href="https://bob.computer" target="_blank" rel="noopener noreferrer">
							bob.computer
						</a>
						,{" "}
						<a href="https://robertweisbecker.com" target="_blank" rel="noopener noreferrer">
							robertweisbecker.com
						</a>
						,{" "}
						<a href="https://weisbecker.design" target="_blank" rel="noopener noreferrer">
							weisbecker.design
						</a>
						,{" "}
						<a href="https://weisbecker.co" target="_blank" rel="noopener noreferrer">
							weisbecker.co
						</a>
						. Someday, buying all those domains will have made sense.
					</p>
					<p>
						The current version of this site was built with <LinkOut href="https://nextjs.org" text="Next.js" /> and{" "}
						<LinkOut href="https://ui.shadcn.com" text="shadcn/ui" />, deployed on GitHub Pages. Icons come from{" "}
						<LinkOut href="https://remixicon.com" text="Remix Icon" />, and components are a mix of shadcn&apos;s and
