...
export default function TestingExplorationsIndex() {
  return (
    <div className="min-h-screen bg-background px-6 py-16">
      <div className="mx-auto max-w-3xl">
        <p className="mb-2 font-pixel text-[11px] text-muted-foreground">
          <Link href="/private/testing" className="hover:text-foreground">
            private/testing
          </Link>{" "}
          / explorations
        </p>
