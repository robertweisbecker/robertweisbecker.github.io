...
function ChromeTabsTab({
  ...
  flush = true,
  ...props
}: TabsPrimitive.Tab.Props & { flush?: boolean }) {
  return (
    <TabsPrimitive.Tab
      value={value}
