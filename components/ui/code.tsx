  ...
  "not-prose relative w-fit h-fit min-w-lh items-center justify-center [&>svg:not([class*='size-'])]:size-[.75em] [&>svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 [&_svg]:opacity-72 select-all box-decoration-clone",
  {
    variants: {
      variant: {
        ...
        default:
          "inline-flex isolate before:rounded before:outline before:outline-popover/50 dark:before:-outline-offset-[0.5px] before:bg-linear-to-b before:from-card before:to-popover dark:before:bg-linear-to-t  px-[0.67ex] before:top-0 before:bottom-[0.125ex] -top-px text-muted-foreground before:shadow-[inset_-0_.0625em_hsl(0_0%_100%_/_5%),_0_.0625em_hsl(0_0%_0%_/_5%),inset_0_-0.125em_0.5em_-.0625em_hsl(0_0%_0%_/_5%),var(--shadow-border-sm),var(--shadow-xs)] gap-[0.25em] text-[.875em] leading-[inherit] before:inset-x-0 before:absolute before:-z-1 mx-px min-h-5",
        inline:
