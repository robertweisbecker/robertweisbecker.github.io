  ...
  ['scroll-32 lg:scroll-18 [&+hr]:my-16 [&+[data-slot="separator"]]:my-16 first:mt-0 last:mb-0 [&+p]:mt-2 text-pretty'],
  {
    variants: {
      level: {
        ...
        3: [
          "text-md scroll-mt-20 font-medium leading-normal tracking-[-.01875rem] text-balance mt-16",
          "has-[+h4]:text-xs has-[+h4]:leading-loose has-[+h4]:font-medium has-[+h4]:font-pixel has-[+h4]:tracking-widest has-[+h4]:uppercase has-[+h4]:text-muted-foreground",
        ],
        4: "text-sm scroll-mt-20 font-medium tracking-snug leading-tight mt-12 opacity-90",
