...
function ToggleGroup({
  ...
  const contextValue = React.useMemo(() => ({ variant, size, spacing, orientation, shape }), [orientation, shape, size, spacing, variant]);
  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        ...
        variant === "elevated" &&
          "bg-accent p-px data-[size=lg]:rounded-xl data-[size=lg]:p-0.5 data-[size=sm]:rounded-[calc(var(--radius-md)+1px)]",
