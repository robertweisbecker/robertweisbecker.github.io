...
export function ColorDiagrams({
  ...
  return (
    <figure className={cn("not-prose flex flex-col gap-4", className)} {...props}>
      ...
      {caption && (
        <figcaption className="flex items-baseline justify-center gap-4 px-2 text-center text-xs text-muted-foreground">
          <em>fig. {type === "luminance" ? "1" : "2"}</em> {caption}
        </figcaption>
      )}
    </figure>
  );
    ...
    <section className="card">
      <div className="svg-wrap">
        <svg viewBox="0 0 900 420" width="100%" role="img" aria-label="Average lightness by step" className="w-full font-pixel">
          ...
          <text x="275" y="33" fontSize="11" fill="var(--foreground)">
            █▇▄▃▁ ∙ NEUTRAL
          </text>
          {/* <rect x="200" y="2" width="11" height="11" fill="var(--color-pink-400)" /> */}
          <text x="545" y="33" fontSize="11" fill="var(--color-pink-400)">
            █▇▅▃▂ ∙ SATURATED
          </text>
          {/* <!-- y grid --> */}
          ...
          <text x="475.00" y="408" textAnchor="middle" fontSize="12" fill="var(--muted-foreground)" fillOpacity={0.5}>
            #
          </text>
          <text x="18" y="207.50" transform="rotate(-90 18 207.50)" textAnchor="middle" fontSize="12" fill="var(--foreground)">
            L% [&mu;]
          </text>
        </svg>
      </div>
...
function AvgChroma() {
  return (
    <section className="card">
      <div className="svg-wrap">
        <svg viewBox="0 0 900 420" width="100%" role="img" aria-label="Average chroma by step" className="w-full font-pixel">
          {/* <!-- legend --> */}
          <g>
            {/* <rect x="70" y="5" width="14" height="14" fill="var(--neutral-400)" /> */}
            <text x="275" y="33" fontSize="11" fill="var(--foreground)">
              ▁▂▃▃▂ ∙ NEUTRAL
            </text>
            {/* <rect x="200" y="5" width="14" height="14" fill="var(--color-pink-400)" /> */}
            <text x="545" y="33" fontSize="11" fill="var(--color-pink-400)">
              ▂▄█▆▃ ∙ SATURATED
            </text>
          </g>
          ...
          <text x="60" y="306.00" textAnchor="end" fontSize="11" fill="var(--muted-foreground)">
            5
          </text>
          <line x1="70" y1="239.00" x2="880" y2="239.00" stroke="var(--border)" strokeWidth="1" />
          <text x="60" y="243.00" textAnchor="end" fontSize="11" fill="var(--muted-foreground)">
            10
          </text>
          <line x1="70" y1="176.00" x2="880" y2="176.00" stroke="var(--border)" strokeWidth="1" />
          <text x="60" y="180.00" textAnchor="end" fontSize="11" fill="var(--muted-foreground)">
            15
          </text>
          <line x1="70" y1="113.00" x2="880" y2="113.00" stroke="var(--border)" strokeWidth="1" />
          <text x="60" y="117.00" textAnchor="end" fontSize="11" fill="var(--muted-foreground)">
            20
          </text>
          <line x1="70" y1="50.00" x2="880" y2="50.00" stroke="var(--border)" strokeWidth="1" />
          <text x="60" y="54.00" textAnchor="end" fontSize="11" fill="var(--muted-foreground)">
            25
          </text>
          ...
          <g>
            <polyline
              ...
              stroke="var(--color-pink-400)"
              strokeWidth="2.5"
              points="70.00,336.75 132.31,308.61  256.92,212.59 319.23,148.41 381.54,98.55 443.85,106.79 506.15,134.08 568.46,167.10 630.77,189.93 693.08,234.48 755.38,272.99 817.69,294.79 880.00,310.09"
            />
            {/* <circle cx="70.00" cy="336.75" r="3.5" fill="var(--color-pink-400)" /> */}
            <circle cx="132.31" cy="308.61" r="3.5" fill="var(--color-pink-400)" />
            {/* <circle cx="194.62" cy="260.72" r="3.5" fill="var(--background)" /> */}
          ...
          <g>
            ...
            />
            {/* <circle cx="70.00" cy="361.08" r="3.5" fill="var(--muted-foreground)" /> */}
            <circle cx="132.31" cy="355.09" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="194.62" cy="351.48" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="256.92" cy="349.47" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="319.23" cy="337.35" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="381.54" cy="323.88" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="443.85" cy="317.71" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="506.15" cy="310.31" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="568.46" cy="311.07" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="630.77" cy="315.52" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="693.08" cy="326.20" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="755.38" cy="333.62" r="3.5" fill="var(--muted-foreground)" />
            <circle cx="817.69" cy="336.62" r="3.5" fill="var(--muted-foreground)" />
            {/* <circle cx="880.00" cy="336.22" r="3.5" fill="var(--muted-foreground)" /> */}
          </g>
