...
function PolaroidFace({ slide }: { slide: Slide }) {
  return (
    <div className="flex h-full w-full flex-col gap-2 p-2">
      ...
      <div className="relative aspect-square flex-1 overflow-hidden bg-muted">
        <Image
          src={slide.src}
          alt={slide.alt}
          fill
          sizes="360px"
          className="object-cover object-top inset-ring inset-ring-input"
          draggable={false}
        />
      </div>
      <div>
              ...
              return (
                <motion.button
                  ...
                  style={{
                    ...
                    boxShadow: isHovered ? "var(--shadow-border-lg)" : isFocused ? "var(--shadow-border-xl)" : "var(--shadow-border-md)",
                  }}
                  className="absolute top-1/2 left-1/2 cursor-pointer bg-card outline-none hover:bg-popover focus-visible:ring-2 focus-visible:ring-primary"
                >
