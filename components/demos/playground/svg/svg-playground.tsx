...
import { PixelMorphToggles } from "@/components/demos/pixels/pixel-morph-toggles";
import { PlaygroundSection } from "@/components/blocks/playground-section";

const DvdLoaderDemo = dynamic(
  () => import("@/components/demos/playground/svg/dvd-loader-demo").then((module) => ({ default: module.DvdLoaderDemo })),
  {
