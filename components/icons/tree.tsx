...
export function TreeIconRichText({ ...props }: React.ComponentProps<"svg">) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" {...props}>
      <path d="M7.25 4C7.66 4 8 4.34 8 4.75C8 5.16 7.66 5.5 7.25 5.5H4.75C4.34 5.5 4 5.16 4 4.75C4 4.34 4.34 4 4.75 4H7.25Z" />
      <path d="M11.25 11.5C11.66 11.5 12 11.84 12 12.25C12 12.66 11.66 13 11.25 13H4.75C4.34 13 4 12.66 4 12.25C4 11.84 4.34 11.5 4.75 11.5H11.25Z" />
      <path d="M4 7.5C4 6.95 4.45 6.5 5 6.5H11C11.55 6.5 12 6.95 12 7.5V9.5C12 10.05 11.55 10.5 11 10.5H5C4.45 10.5 4 10.05 4 9.5V7.5Z" />
      <path d="M10.75 0C10.95 0 11.14 0.08 11.28 0.22L14.78 3.72C14.92 3.86 15 4.05 15 4.25V13.25C15 14.77 13.77 16 12.25 16H3.75C2.23 16 1 14.77 1 13.25V2.75C1 1.23 2.23 0 3.75 0H10.75ZM3.75 1.5C3.06 1.5 2.5 2.06 2.5 2.75V13.25C2.5 13.94 3.06 14.5 3.75 14.5H12.25C12.94 14.5 13.5 13.94 13.5 13.25V5H12.25C11.01 5 10 3.99 10 2.75V1.5H3.75Z" />
    </svg>
  );
}
